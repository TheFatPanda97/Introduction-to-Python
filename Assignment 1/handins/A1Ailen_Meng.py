...
num_guess = 0
guess = int(input("Guess what the number is (number of guesses right now, {}): ".format(num_guess)))

while guess != num:
    message, num_guess = varify(guess, num, num_guess)
    guess = int(input("{} (number of guess right now, {}): ".format(message, num_guess)))
